...
const Chats = React.memo(({ selectedUser }) => {
  ...
  return (
    <div className="right-container w-[100%] h-[90%] bg-white flex flex-col relative scrollbar-hide overflow-y-scroll">
      {roomid ? (
        <div className="flex flex-col h-full">
          <div className="messages flex flex-col p-4 overflow-y-auto flex-grow">
            {postmsgs.map((msg) => (
        ...
        <h1 className="msg p-[30vmax] opacity-30 text-base">Tap into the any user</h1>
      )}
    </div>
  );
});
